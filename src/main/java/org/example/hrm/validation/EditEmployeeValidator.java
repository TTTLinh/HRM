...
public class EditEmployeeValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (employeeDTO.getPhone() == null || employeeDTO.getPhone().trim().isEmpty()) {
            ...
            }else if (iEmployee.existsByPhone1(employeeDTO.getPhone())){
        ...
        if (employeeDTO.getEmail() == null || employeeDTO.getEmail().trim().isEmpty()) {
            ...
            }else if (iEmployee.existsByEmail1(employeeDTO.getEmail())){
                errors.rejectValue("email", "Email", "Nhập email đã tồn tại!!");
            }
        }
